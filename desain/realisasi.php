...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="realisasi.php">Realisasi Desain</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Realisasi Design</h1>
                    <div class="mb-4">
                                ...
                                <div class="modal-body">
                                    <form method="post">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="tambahhubrealisasi">Tambah</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="row" id="hubContainer">
                        <?php
                        // Ambil data realisasi hub
                        $query = "SELECT idrealisasi, hub FROM realisasi";
                        $result = mysqli_query($conn, $query);

                        while ($hub = mysqli_fetch_assoc($result)) {
                            $hub_id = $hub['idrealisasi'];
                            $hub_name = $hub['hub'];

                            // Ambil foto terkait hub
                            $foto_query = "SELECT id, idrealisasi, judul, foto FROM realisasi_foto WHERE idrealisasi = '$hub_id'";
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form method="post" action="">
                                                            ...
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                                            <button type="submit" class="btn btn-danger" name="hapus_hub_realisasi">Hapus</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-4 mb-3">
                                                        ...
                                                        <div class="card" style="position: relative;">
                                                            ...
                                                            <form method="post" style="position: absolute; top: 5px; right: 5px;">
                                                                ...
                                                                <button type="submit" class="btn btn-danger btn-sm" name="hapusfoto_realisasi" title="Hapus Foto" onclick="return confirm('Anda yakin ingin menghapus foto ini?');">X</button>
                                                            </form>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="modal-body">
                                                <input type="hidden" name="idrealisasi" value="<?= $hub_id; ?>">
                                                <div class="mb-3">
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                                <button type="submit" class="btn btn-primary" name="upload_foto_realisasi">Upload</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
